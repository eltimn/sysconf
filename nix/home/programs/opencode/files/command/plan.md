---
description: Create detailed implementation plan through interactive process
agent: plan
subtask: false
---
...
2. **Spawn initial research tasks** using subagents:
   - **@rpi-find-files**: Find all files related to the ticket/task
   - **@rpi-analyze-code**: Understand current implementation
   - **@rpi-find-patterns**: Find similar features to model after
...
2. **Spawn parallel sub-tasks for comprehensive research**:
   - **@rpi-find-files**: Find more specific files
