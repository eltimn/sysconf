...
Find all files related to the search query. Use ripgrep and file listing to locate relevant files.
Return file paths with brief descriptions. Do NOT read entire files - just locate them and note their purpose.
